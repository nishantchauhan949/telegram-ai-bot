...
def bard_query_handler(message):
    """
    The bard_query_handler function is the main function that6 handles user queries.
    ...
    user_query += ' Please keep it under 4096 characters.'
    ...
    print('\n***********************************************************************\n')
    bot.send_message(chat_id=message.chat.id, text=bard_response)
